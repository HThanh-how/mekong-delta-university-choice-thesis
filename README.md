...
Tác giả: **Phạm Duy Tân (B2407059)**, ngành Kỹ thuật điện, K50, Khoa Kỹ thuật điện, Trường Bách khoa, Đại học Cần Thơ. Cán bộ hướng dẫn: **TS. Ngô Quang Hiếu**.
...
xelatex -interaction=nonstopmode -halt-on-error main.tex
xelatex -interaction=nonstopmode -halt-on-error main.tex
Copy-Item -Force main.pdf output/pdf/luan-van-chon-truong-nganh-dbscl.pdf
```
...
python analysis/generate_diagnostic_figures.py
```
